   ...
   var getPoster = function(){
        ...
        var film = $('#term').val();
         ...
         if(film == ''){
            ...
            $.getJSON("http://api.themoviedb.org/2.1/Movie.search/en/json/a12e84be9ffed661d18b00b87ceffd35/" + film + "?callback=?", function(json) {
               if (json != "Nothing found."){
                     ...
                     $.getJSON("http://api.themoviedb.org/2.1/Movie.search/en/json/a12e84be9ffed661d18b00b87ceffd35/goonies?callback=?", function(json) {
                        console.log(json);
