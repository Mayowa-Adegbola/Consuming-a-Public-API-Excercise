   ...
   var getPoster = function(){
        ...
        var film = $('#term').val();
         ...
         if(film == ''){
            ...
            $.getJSON("http://api.themoviedb.org/3/search/movie?api_key=a12e84be9ffed661d18b00b87ceffd35/" + film + "?callback=?", function(json) {
...
a12e84be9ffed661d18b00b87ceffd35/goonies?callback=?", function(json) {
                        console.log(json);
